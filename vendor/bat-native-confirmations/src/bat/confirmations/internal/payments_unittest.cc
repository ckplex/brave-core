...
TEST_F(BatConfirmationsPaymentsTest,
    SetFromJsonWithInvalidArrayJson) {
  // Arrange
...
TEST_F(BatConfirmationsPaymentsTest,
    DefaultBalanceForInvalidIntType) {
  // Arrange
  const std::string json = R"(
    [
      {
...
TEST_F(BatConfirmationsPaymentsTest,
    DefaultTransactionCountForInvalidValue) {
  // Arrange
  const std::string json = R"(
    [
      {
...
TEST_F(BatConfirmationsPaymentsTest,
    DefaultTransactionCountForInvalidIntType) {
  // Arrange
  const std::string json = R"(
    [
      {
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.25\",\"month\":\"2019-05\",\"transactionCount\":\"5\"},{\"balance\":\"0.5\",\"month\":\"2019-06\",\"transactionCount\":\"10\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.5\",\"month\":\"2019-06\",\"transactionCount\":\"10\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.5\",\"month\":\"2019-06\",\"transactionCount\":\"10\"},{\"balance\":\"0.25\",\"month\":\"2019-05\",\"transactionCount\":\"5\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0\",\"month\":\"2019-07\",\"transactionCount\":\"0\"},{\"balance\":\"0.25\",\"month\":\"2019-06\",\"transactionCount\":\"5\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.25\",\"month\":\"2019-06\",\"transactionCount\":\"5\"},{\"balance\":\"0\",\"month\":\"2019-07\",\"transactionCount\":\"0\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"1.5\",\"month\":\"2019-07\",\"transactionCount\":\"30\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0\",\"month\":\"2019-06\",\"transactionCount\":\"0\"},{\"balance\":\"0\",\"month\":\"2019-05\",\"transactionCount\":\"0\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0\",\"month\":\"2019-05\",\"transactionCount\":\"0\"},{\"balance\":\"0\",\"month\":\"2019-06\",\"transactionCount\":\"0\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.5\",\"month\":\"2019-07\",\"transactionCount\":\"10\"},{\"balance\":\"0\",\"month\":\"2019-06\",\"transactionCount\":\"0\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0\",\"month\":\"2019-06\",\"transactionCount\":\"0\"},{\"balance\":\"0.5\",\"month\":\"2019-07\",\"transactionCount\":\"10\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.25\",\"month\":\"2019-05\",\"transactionCount\":\"5\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"0.0\",\"month\":\"2019-07\",\"transactionCount\":\"0\"},{\"balance\":\"1.75\",\"month\":\"2019-06\",\"transactionCount\":\"35\"}]";  // NOLINT
  payments_->SetFromJson(json);
...
TEST_F(BatConfirmationsPaymentsTest,
  ...
  // Arrange
  const std::string json = "[{\"balance\":\"1.75\",\"month\":\"2019-06\",\"transactionCount\":\"35\"},{\"balance\":\"0.0\",\"month\":\"2019-07\",\"transactionCount\":\"0\"}]";  // NOLINT
  payments_->SetFromJson(json);
